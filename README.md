...
- ```allItems = List.of(new Item("Book", 10, 500, 0.2)), cardNumber = "123456789"``` </br>
...
- ```allItems = List.of(new Item("Book", 10, 500, 0.2)), cardNumber = "4cardNumberOfAna"``` </br>
