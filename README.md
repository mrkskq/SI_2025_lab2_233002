...
- Тест случај 3: ```allItems = List.of(new Item("Book", 10, 500, 0.2)), cardNumber = "123456789"```
...
- Тест случај 4: ```allItems = List.of(new Item("Book", 10, 500, 0.2)), cardNumber = "4cardNumberOfAna"```
...
- Тест случај 5: ```allItems = List.of(new Item("Book", 10, 500, 0.0)), cardNumber = "0122333444455555"```
...
Потребни се минимум 4 комбинации за да се постигне овој критериум. Ова е така бидејќи со Lazy Evaluation ќе се елиминираат некои од комбинациите од табелата. Наместо да имаме 2^3=8 комбинации, ќе имаме само 4. Истите може да ги ставиме само во 1 тест случај - како листа од 4-те Items. Значи соодветно би ги имале следниве комбинации:
- TXX: ```new Item("Book", 10, 500, 0.0)```
...
А ако ги ставиме во листа имаме:
- ```List.of(new Item("Book", 10, 500, 0.0), new Item("Book", 10, 200, 0.3), new Item("Book", 15, 200, 0.0), new Item("Book", 5, 200, 0.0)), "4cardNumberOfAna"));```
> Објаснување: Во for циклусот кај јазол 4.2 ќе се изминат сите 4 комбинации.
Истото ова го пробав и во Gradle со помош на assert израз и успешно ми помина тестот.
